...
import FaceCameraVerify from "~/pages/attendance/FaceCameraVerify.jsx";
  ...
  return (
    <React.Fragment>
      ...
      >
            ...
            >
              <Typography
                ...
                sx={{
                  fontSize: "0.875rem",
                  fontWeight: 600,
                  color: isVietnamese ? "text.secondary" : "primary.main",
                }}
              >
                🇺🇸 EN
              </Typography>
              ...
              <Typography
                ...
                sx={{
                  fontSize: "0.875rem",
                  fontWeight: 600,
                  color: isVietnamese ? "primary.main" : "text.secondary",
                }}
              >
                🇻🇳 VI
              </Typography>
        ...
        {/* Thêm MenuItem mở modal chấm công mặt */}
        <MenuItem
          onClick={() => {
            navigate("/attendance"); // Chuyển trang
