                  ...
                  >
                    ...
                    <Box
                      sx={{
                        ...
                        width: 8,
                        height: 8,
                        background: alpha(stat.color, 0.3),
                        borderRadius: "50%",
                        opacity: 0.6,
              ...
              >
                ...
                >
                  ...
                  {ROLE_CONFIGS.map((role) => (
                    <MenuItem key={role.value} value={role.value} sx={{ p: 1 }}>
            ...
            <Box>
              ...
              <Stack direction="row" spacing={1} flexWrap="wrap">
                ...
                {statusFilter && (
                  <Chip
                    label={
                      statusFilter === "true" ? t("enabled") : t("disabled")
                    }
                    onDelete={() => setStatusFilter("")}
                    color={statusFilter === "true" ? "success" : "error"}
                    variant="filled"
                    size="small"
                  />
                )}
                          ...
                          >
                            <Box
                              sx={{
                                ...
                                height: 8,
                                borderRadius: "50%",
                                backgroundColor: acc.enabled
                                  ? theme.palette.success.main
                                  : theme.palette.error.main,
                              }}
                            />
                            <Typography>
                              {t(acc.enabled ? "enabled" : "disabled")}
                            </Typography>
                          </Stack>
                        </Box>
                      </TableCell>
                      <TableCell>
                        <Box>
                          <Typography variant="body2" fontWeight="medium">
                            {formatLongDate(acc.createdAt, i18n.language)}
                          </Typography>
                          <Typography variant="caption" color="text.secondary">
                            {t("UpdatedAt")}:{" "}
                            {formatLongDate(acc.updatedAt, i18n.language)}
                          </Typography>
                        </Box>
                      </TableCell>
                      <TableCell>
                  ...
                  {accounts.length > 0 &&
                    ...
                    Array.from({
                      ...
                      <TableRow key={`empty-${idx}`}>
                        <TableCell colSpan={6} sx={{ height: 70 }} />
                      </TableRow>
                    ))}
                </>
              )}
        ...
        >
          ...
          >
            <Typography variant="body2" color="text.secondary">
              ...
              <strong>{stats.totalAccounts}</strong> {t("Results")}
            </Typography>
            <Pagination
              color="primary"
              count={totalPage}
