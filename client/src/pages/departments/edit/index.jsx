...
export default function EditDepartmentPage() {
	...
	const onSubmit = async (data) => {
		...
		const res = await editDepartmentApi(formData)
		setLoading(false)
	...
	const handleGetDepartmentById = async () => {
		...
		if (res.status === 200) {
			...
			setValue("hodId", res.data.hod.id)
			setDepartmentImage(res.data.image)
		}
	}
			...
			>
				...
				<Box>
					...
					<Typography variant="body2" sx={{ opacity: 0.9 }}>
						{t("edit-departments-in-your-organization")}
					</Typography>
				</Box>
			</Box>
