...
const BeautifulAlert = ({message, type = "error"}) => {
    ...
    const colorMain = isSuccess ? theme.palette.primary.main : theme.palette.error.main
    const colorDark = isSuccess ? theme.palette.primary.dark : theme.palette.error.dark
